...
/*
void buildCard(int parameter_cnt) //parameter_name,int parameter_value)//String parameter_name, String parameter_value)
{
  temp_buildCard = "<div class=\"card bg-primary\"><div class=\"card-body text-center\"><p class=\"card-text\">";
  temp_buildCard += par_names[parameter_cnt][1];
  temp_buildCard += "</p><p class=\"card-text\">";
  temp_buildCard += par_values[parameter_cnt];
  temp_buildCard += "</p> </div></div>";
}

void buildPage(int lang)
{
  temp_buildPage = page_start;
  temp_buildPage += millis();
  for(int i = 0; i<6;i++)
  {
    buildCard(i);
    temp_buildPage += temp_buildCard;
  }
  temp_buildPage += millis();
  temp_buildPage += page_end;
}
*/
...
void loop() {
 ...
 {   
//buildCard(1);
//  client.println(temp_buildCard);
 // Serial.print(temp_buildCard);
